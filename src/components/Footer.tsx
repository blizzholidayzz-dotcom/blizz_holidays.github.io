  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-red-500 to-orange-500"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <h3 className="text-2xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-red-400">
              BLIZZ HOLIDAYZ
            </h3>
            <p className="text-gray-400 italic mb-4">let's travel with us</p>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 bg-red-500 rounded-full group-hover:w-3 transition-all"></span>
                  Home
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a href="tel:8190056589" className="text-gray-400 hover:text-white transition-colors block">
                    8190056589
                  </a>
                  <a href="tel:8110880579" className="text-gray-400 hover:text-white transition-colors block">
                    8110880579
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:blizzholidayzz@gmail.com" className="text-gray-400 hover:text-white transition-colors break-all">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="w-10 h-10 bg-gradient-to-br from-pink-500 to-orange-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                  <Instagram className="w-5 h-5 text-white" />
                </div>
                <span className="font-semibold">@blizz_holidayz</span>
              </a>
